...
export const studentLinks = [['Dashboard','/student/dashboard'],['My Learning Path','/student/learning'],['Assessments','/student/assessments'],['My Skill Scores','/student/skills'],['Employability Summary','/student/employability'],['Certificates','/student/certificates']] as const;
